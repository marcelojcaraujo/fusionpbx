<?php
	...
	$y=0;
	$apps[$x]['menu'][$y]['title']['en-us'] = "IVR Surveys";
	$apps[$x]['menu'][$y]['title']['en-gb'] = "IVR Surveys";
	...
	$apps[$x]['menu'][$y]['title']['nl-nl'] = "IVR Survey";
	...
	$apps[$x]['menu'][$y]['uuid'] = "72259497-a67b-e5aa-cac2-0f2dcef16309";
	$apps[$x]['menu'][$y]['parent_uuid'] = "fd29e39c-c936-f5fc-8e2b-611681b266b6";
	$apps[$x]['menu'][$y]['category'] = "internal";
	$apps[$x]['menu'][$y]['path'] = "/app/ivr_surveys/ivr_surveys.php";
